...
<body class="bg-gradient-primary  body-bg-t1">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row shadow">
              <div class=" d-none d-lg-block bg-login-image pp1"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="btn btn-primary btn-user btn-block  btn-p-t1" type="submit" name="btnlogin">Login</button>
                    <hr>
                  <!-- <div class="text-center">
