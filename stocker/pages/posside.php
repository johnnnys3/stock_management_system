...
?> 
          ...
          <div class="form-group row text-left mb-3">
            ...
            <?php echo $opt; ?>
            <a  href="#" data-toggle="modal" data-target="#poscustomerModal" type="button" class="btn btn-primary -primary" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a>
            </div>
                    ...
                    <div class="col-sm-12 mb-2">
                      <div class="input-group mb-2">
                        <div class="input-group-prepend">
                          ...
                          <input class="form-control text-right" id="txtNumber" value=<?php echo number_format($total, 2); ?> onkeypress="return isNumberKey(event)" type="text" name="cash" placeholder="ENTER CASH" name="cash" required>
                    </div>
                  </div>
              </div>
