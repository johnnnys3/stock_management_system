          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <div class="form-group row text-left mb-0">
                <div class="col-sm-9">
                  <h5 class="font-weight-bold sales-inventory">
                    Sales and Inventory
                  </h5>
                  <h2 class="font-weight-bold receipt-h4">
                    Official Reciept
                  </h2>
                </div>
                <div class="col-sm-3 py-1">
                 <spann class="recipt-brand">
...
?>
            ...
            <div class="form-group row text-left mb-0 py-2">
                ...
                <div class="col-sm-4 py-1">
                  <h4>
                    Cash Amount: GH₵ <?php echo number_format($cash, 2); ?>
                  </h4>
                  <table width="100%">
                    <tr>
                  ...
                  <!-- print function -->
                        ...
                        <button id="print" class="btn btn-primary " onclick="printPage()">
